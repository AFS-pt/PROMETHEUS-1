...
class lora_gui(gr.top_block, Qt.QWidget):

    def __init__(self, plutoIP='ip:192.168.2.1'):
        gr.top_block.__init__(self, "Lora Gui", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Lora Gui")
        ...
        self.settings = Qt.QSettings("GNU Radio", "lora_gui")
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/home/diomig/Desktop/testfile.txt', True)
...
def main(top_block_cls=lora_gui, options=None):
    if options is None:
