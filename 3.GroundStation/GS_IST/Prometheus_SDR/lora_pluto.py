...
class lora_pluto(gr.top_block):

    def __init__(self, plutoIP='ip:192.168.2.1'):
        gr.top_block.__init__(self, "Lora Pluto", catch_exceptions=True)
        ...
        self.cr = cr = 2
        self.center_freq = center_freq = 436567500
        self.bw = bw = 125000
        ...
        self.blocks_message_strobe_0 = blocks.message_strobe(pmt.intern("TEST: 0"), 1000)
...
def main(top_block_cls=lora_pluto, options=None):
    if options is None:
